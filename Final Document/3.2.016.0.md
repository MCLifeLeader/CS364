...
|Basic Path	| 1. User accesses the calender.<br/> 2. User taps a day in the calender and creates an event.<br/> 3. User defines the number of times the event repeats.<br/> |
|Alternate Path	| None.|			
