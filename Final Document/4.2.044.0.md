...
The tester will load the app onto a mobile device and then tap the “Badge” button to view the badges for notifications.  If there are no notifications then the user will receive an error message letting them know. 
