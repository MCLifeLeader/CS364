...
[EDITORS: Not trying to define or create the database and tables. We need to describe the kinds of data that will be required in the schema. More high level. Include type and limitations of the kinds of data to be used. This should not look like database schema.]
