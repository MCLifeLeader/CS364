...
| Data          | Description |
|:--------------| :--------------|
|Use Case Detail| Option to share calendar with others.|
|XRef           |  |
|Trigger        | The user selects one or more calendars, and one or more people to share them with.|
|Precondition   | The user must have already created one or more calendars.|
|Basic Path     | <li type='1'>In the settings the user selects “share calendar(s)”</li><li type='1'>The user selects the calendar(s) they want to share.</li><li type='1'>The user selects the people to share the calendar(s) with.</li>|
|Alternate Path |  |
|Post Condition | The people selected receive a notification, and have the option to view the user's calendar(s).|
|Exception Paths| If the user has not created any calendars.|
|Other          |  |
...
### 3.2.132 Apple Maps Integration 
&
### 3.2.133 Other Maps Integration (Google Maps Integration should work this way too)
