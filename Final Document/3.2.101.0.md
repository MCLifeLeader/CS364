...
| Data          | Description |
|:--------------| :--------------|
|Use Case Detail| Allows a student to log in to their existing acount and gain access to their information|
|XRef           ||
...
#### 3.2.141.2 Creae New Account
| Data          | Description |
|:--------------| :--------------|
|Use Case Detail| Allows a student to create an account and reatain their personal information inside the system|
|XRef           ||
