...
|Basic Path	    | 1. User logs into I-Learn through app. 2. The user tapes the 'Calendar' icon. 3. The user tapes a 'See all' button on one day in the Calendar. 4. The list of events for that day is expanded. |
|Alternate Path | None|
