...
|Post Condition | The next assignment in the list is displayed on the screen. The assignment will be marked as complete on the main calendar. |
...
|Precondition   | The user is on the simplified display page. |
|Basic Path     | The next assignment in the list displays on screen.|
|Alternate Path | The user may select the left arrow to move to preceding assignments in the list. |
|Post Condition | The corresponding assignment displays on the screen |
...
|Alternate Path | The user may insert alternative text for the assignment to be displayed in the list. |
