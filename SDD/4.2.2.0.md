...
<td rowspan = "4">recoverPassword</td>
    <th>Method Description</th>
  </tr>
  <tr>
  ...
  <td rowspan = "4">recoverUsername</td>
    <th>Method Description</th>
  </tr>
  <tr>
...
<td rowspan = "4">printToDoList</td>
  ...
  <tr>
    <td>Allows the user to print out their To-Do list. When the user clicks the print button at the bottom of the To-Do list page the To-Do list is sent to the printerFacade class which handles the print job.<br>
    Parameters:<br>
    toDoList[] - an array holding all of the user's to-do list items.<br>
    Return:<br>
    A boolean that is true if recovery was successful.<br>
    </td>
  </tr>
...
<td rowspan = "4">printCalendar</td>
  ...
  <tr>
    <td>Allow the user to print out their calendar. When the user clicks the print button at the top of the calendar page the calendar is sent to the printerFacade class which handles the print job.<br>
    Parameters:<br>
    calendar - an object of type calendar taht holds all of the user's calendar information.<br>
    </td>
  </tr>
...
<td rowspan = "4">get_Ilearn_Assignments</td>
    <th>Method Description</th>
  </tr>
  <tr>
...
<td rowspan = "4">importCalendar</td>
    <th>Method Description</th>
  </tr>
  <tr>
  ...
  <td rowspan = "4">exportCalendar</td>
    <th>Method Description</th>
  </tr>
  <tr>
