...
<table>
  ...
  <tr>
    <td>  dayNames <- (“Sun”, “Mon”, “Tue”, “Wed”, “Thu”, “Fri”, “Sat”)
  timeArray <- (“1am”, “2am”, “3am”… “11pm”)
  dayOfTheWeek <- getDayOfTheWeek(date, dayNames);
  dayView <- createCalendarDay(dayNames, dayOfTheWeek, timeArray, getEvents(), getAssignments(), date)
