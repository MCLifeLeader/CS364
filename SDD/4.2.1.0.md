...
<table>
  ...
  <tr>
    <td>This method is called when the print button is pressed from the main calendar page view. It also invokes the system procedures for printing a page. It will open the default print dialog for printing a page in the web browser.</td>
  </tr>
  <tr>
    <th>Method Pseudo Code</th>
  </tr>
