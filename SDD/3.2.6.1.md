...
| Type: | Process. |
| Purpose: | To have the Assignmetns in I-Learn transfer over to the Calendar automatically to see their due dates and description of the assignments their in the Calendar. |
| Parent User Story:| |
