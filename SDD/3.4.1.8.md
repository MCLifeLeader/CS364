...
| Links: | None.|
| SRS Document | 3.2.26 |
| Description/Notes:|Show Holidays
1. The user chooses to view the calendar by Day, by Week, and by Month.
2. The user will see a text label on national holidays.|
